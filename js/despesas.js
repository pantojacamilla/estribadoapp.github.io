...
class UI {
    ...
    static adicionaDespesaNaTabela(despesa) {
        const list = document.querySelector('#tabelaDespesas');
    ...
    static mostraAlerta(mensagem, className) {
        ...
        const formulario = document.querySelector('#despesas');
...
document.querySelector('#despesas').addEventListener('submit', (e) => {
...
document.querySelector('#tabelaDespesas').addEventListener('click', (e) => {
